        ...
        <div className="h-screen md:flex">
            <div
                ...
                <div>
                    ...
                    <p className="text-white mt-1">You don't have an account yet?</p>
                    <NavLink to="/register">
            ...
            <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
                <form className="bg-white" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    {!isLoaded ? <button type="submit" className="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">
                        Login
                    </button> : "Loading..."}

                    {loginError ? <p className='mb-4 text-rose-400 text-center'>{loginError}</p> : null}
